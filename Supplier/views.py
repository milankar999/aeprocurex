...
def suppliers(request):
        ...
        if request.method == "GET":     
                ...
                if type == 'Accounts':
                        return render(request,"Accounts/Supplier/supplier.html",context)


        if request.method == "POST":
                if type != 'Accounts':
                        return JsonResponse({'message':'You are not allowed to edit vendor'})
                ...
                if data['advance'] == '':
                        ...
                        adv = data['advance']
                ven = SupplierProfile.objects.create(
                        id=supplier_id,
                        name=data['name'],
...
def supplier_details(request, id=None):
        ...
        if request.method == "GET":
                ...
                if type == 'Accounts':
                        return render(request,"Accounts/Supplier/supplier_details.html",context)
...
def supplier_edit(request, id=None):
        ...
        if request.method == "GET":
                ...
                if type == 'Accounts':
                        return render(request,"Accounts/Supplier/supplier_edit.html",context)
...
def supplier_contact_person(request,id=None):
        ...
        if request.method == "GET":
                ...
                if type == 'Accounts':
                        return render(request,"Accounts/Supplier/contact_person.html",context)
        ...
        if request.method == "POST":
                ...
                cp = SupplierContactPerson.objects.create(
                        id=contactperson_id,
                        name=data['name'],
...
def supplier_contact_person_edit(request,supp_id=None,person_id=None):
        ...
        if request.method == "GET":
                ...
                if type == 'Accounts':
                        return render(request,"Accounts/Supplier/contact_person_edit.html",context)
        ...
        if request.method == "POST":
                ...
                return HttpResponseRedirect(reverse('supplier_contact_person',args=[supp_id]))

#Supplier Registration documents
@login_required(login_url="/employee/login/")
def supplier_documents(request,id=None):
        context={}
        context['supplier'] = 'active'
        u = User.objects.get(username=request.user)
        type = u.profile.type
        ...
        if request.method == 'GET':
                supplier = SupplierProfile.objects.get(id = id)
                doc = SupplierDocuments.objects.filter(supplier = supplier)

                context['supplier_id'] = supplier.id
                context['doc'] = doc
                
                if type == 'Accounts':
                         return render(request,"Accounts/Supplier/supplier_attachments.html",context)
        ...
        if request.method == 'POST':
                ...
                SupplierDocuments.objects.create(
                        supplier = supplier,
                        description = data['description'],
                        attachment = myfile
                )
                return HttpResponseRedirect(reverse('supplier_registration_documents',args=[id]))

#Delete Supplier Registration Document
@login_required(login_url="/employee/login/")
def supplier_documents_delete(request,id=None,attachment_id = None):
        context={}
        context['supplier'] = 'active'
        u = User.objects.get(username=request.user)
        type = u.profile.type
        ...
        if request.method == 'GET':
                ...
                if type == 'Accounts':
                         return render(request,"Accounts/Supplier/supplier_attachments_delete.html",context)

        if request.method == 'POST':
                sd = SupplierDocuments.objects.get(id = attachment_id)
                sd.delete()
                return HttpResponseRedirect(reverse('supplier_registration_documents',args=[id]))