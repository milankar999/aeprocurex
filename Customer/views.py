...
def customers(request):
        ...
        if request.method == "POST":
                ...
                if user.profile.creating_customer == 'no':
                        return JsonResponse({'message':'you do not have permission to create customer'})
                data = request.POST
...
def customer_edit(request, id=None):
        ...
        if user.profile.customer_editing == 'no':
                return JsonResponse({'message' : 'You Do not have permission to edit customer'})
